    ...
    <div class="mb-4 shadow card">
        <div class="card-body">
            ...
            <div class="flex-wrap mb-3 d-flex justify-content-end">
                ...
                <div class="ml-1">
                    <select id="complaintFilter" class="form-control" style="width: 7.6rem">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex-row flex-wrap d-flex" style="gap: 0.5rem">
                                    <a href="{{route('complaint.show', ['complaint' => $complaint->id])}}"
                                        class="w-100 btn btn-primary">
                                        Detail
                                    </a>
                                    <a href="{{route('thread.show', ['thread' => $complaint->thread->id])}}"
                                        class="w-100">
                                        <button class="btn btn-warning w-100">Thread</button>
                                    </a>
