...
<head>
    <title>BPI UI - User Complaint</title>
                ...
                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-radius: 2px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015); margin: 0 auto; width: 570px;">
                    <tr>
                        <td class="content-cell" style="padding: 32px;">
                            <h1 style="color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">Pengaduan Baru</h1>
                            ...
                            <p style="font-size: 16px; line-height: 1.5em; text-align: justify;">
                                Seorang pengguna baru saja menambahkan pengaduan dengan informasi berikut:
                            </p>
                            <ul style="font-size: 16px; line-height: 1.5em; text-align: justify;">
                                ...
                                <li><strong>Nomor BPI :</strong> {{ $bpiNumber }}</li>
                                <li><strong>Jenis Aduan :</strong> {{ $complaintTypeTitle }}</li>
                            </ul>
                            <p style="font-size: 16px; line-height: 1.5em; text-align: justify;">
                                Silakan tinjau dan setujui pengaduan pengguna ini melalui halaman admin jika diperlukan.
                            </p>
