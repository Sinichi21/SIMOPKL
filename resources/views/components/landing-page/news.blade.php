...
<body style="font-family: 'Poppins', sans-serif">
    <header class="absolute top-0 left-0 right-0 z-50">
        <nav class="fixed top-0 w-full px-1 transition-all duration-300 ease-in-out bg-white border-gray-200 shadow-sm lg:px-1"
    id="navbar">
    <div class="flex flex-wrap items-center justify-between mx-auto h-[96px] max-w-[1280px]">
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <hr class="mt-3" />
                    <ul class="flex flex-col items-center gap-0.5 my-5 mt-4 font-medium lg:flex-row lg:gap-0 lg:mt-0">
                        <li class="flex items-center relative -top-1.5">
                            ...
                            <div id="userDropdown"
                                ...
                                <ul class="px-0 grid py-2 text-sm text-gray-700 " aria-labelledby="avatarButton">
                                    @if ($user->awardee)
                                    <li>
                                        <a href="{{route('awardee.profile', ['user' => $user->id])}}" class="w-full hover:bg-gray-100 px-3 py-2 flex items-center text-gray-700 no-underline">
                                            Profile
                                        </a>
                                    </li>                                    
                                    <li>
                                        <a href="{{route('complaint.index')}}" class="w-full hover:bg-gray-100 px-3 py-2 flex items-center text-gray-700 no-underline">
                                            Member area
                                        </a>
                                    </li>
                                    @endif
                                    ...
                                    <li>
                                        <a href="{{route('admin.index')}}" class="w-full hover:bg-gray-100 px-3 py-2 flex items-center text-gray-700 no-underline">
                                            Admin area
                                        </a>
                                    </li>
                                    @endif
                                    <li>
                                        <a href="{{route('logout')}}" class="w-full hover:bg-gray-100 px-3 py-2 flex items-center text-gray-700 no-underline">
                                            Logout
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li class="flex items-center">
                            <a href="{{route('login')}}"
                                class="focus:outline-none text-white bg-indigo-400 hover:bg-indigo-500 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2.5 me-2 no-underline">
                                Masuk
                            </a>
                        </li>
                        <li class="flex items-center">
                            <a href="{{route('register.index')}}"
                                class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-4 py-2.5 me-2 no-underline">
                                Daftar
                            </a>
                        </li>                        
                        @endguest
