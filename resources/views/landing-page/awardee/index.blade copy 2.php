<x-landing-page.layout>
    ...
    <section class="splide w-full h-screen absolute top-0 left-0 right-0 z-[-1]">
        <div class="splide__track">
            <div class="splide__list h-screen">
    ...
    <section class="mt-[80vh] space-y-36 lg:space-y-56">
        <div class="grid lg:grid-cols-2 gap-4 px-5 lg:px-20 w-[90%] xl:w-[80%] items-center mx-auto justify-center">
            <div class="flex flex-col gap-4 items-end">
                <div class="relative rounded-lg overflow-hidden w-[248px] h-[165px] md:w-[651px] md:h-[434px] lg:w-[417px] lg:h-[278px]">
                    <img class="object-cover w-full h-full" src="{{ asset('storage/' . $Image['awardee']->url) }}" alt="" />
                    <a class="bg-gradient-to-l from-red-300/30 to-red-600/50 absolute top-0 left-0 right-0 bottom-0 p-10 opacity-0 transition-opacity hover:opacity-100 duration-500 hover:backdrop-blur-sm"
                        href="{{ route('landing-page.awardee.index') }}">
                        <p class="font-bold text-3xl text-white">Awardee</p>
                        <p class="font-semibold text-2xl absolute bottom-10 right-10 text-white">
                            {{ $totaluser }} Awardee
                        </p>
                    </a>
                </div>
                <div class="lg:w-[70%] relative overflow-hidden rounded-lg w-[248px] h-[248px] md:w-[400px] md:h-[400px] lg:w-[292px] lg:h-[292px]">
                    <img class="object-cover w-full h-full" src="{{ asset('storage/' . $Image['faq']->url) }}" alt="" />
                    <a class="bg-gradient-to-l from-red-300/30 to-red-600/50 absolute top-0 left-0 right-0 bottom-0 p-10 opacity-0 transition-opacity hover:opacity-100 duration-500 hover:backdrop-blur-sm"
                        href="{{route('landing-page.faq.index')}}">
                        <p class="font-bold text-3xl text-white">FAQ</p>
                        <p class="font-semibold text-2xl absolute bottom-10 right-10 text-white">
                            {{$totalFaq}} FAQ
                        </p>
                    </a>
            ...
            <div class="flex flex-col gap-4">
                <div class="relative rounded-lg overflow-hidden w-[248px] h-[129px] md:w-[651px] md:h-[338px] lg:w-[417px] lg:h-[217px]">
                    <img class="object-cover w-full h-full" src="{{ asset('storage/' . $Image['pengaduan']->url) }}" alt="" />
                    @guest
                    <a class="bg-gradient-to-l from-red-300/30 to-red-600/50 absolute top-0 left-0 right-0 bottom-0 p-10 opacity-0 transition-opacity hover:opacity-100 duration-500 hover:backdrop-blur-sm"
                        href="{{route('complaint.index')}}">
                        <p class="font-bold text-3xl text-white">Pengaduan</p>
                    </a>
                    @endguest
                    @auth
                    <a class="bg-gradient-to-l from-red-300/30 to-red-600/50 absolute top-0 left-0 right-0 bottom-0 p-10 opacity-0 transition-opacity hover:opacity-100 duration-500 hover:backdrop-blur-sm"
                ...
                <div class="relative rounded-lg overflow-hidden w-[248px] h-[139px] md:w-[651px] md:h-[336px] lg:w-[417px] lg:h-[235px]">
                    <img class="object-cover w-full h-full" src="{{ asset('storage/' . $Image['gallery']->url) }}" alt="" />
                    <a class="bg-gradient-to-l from-red-300/30 to-red-600/50 absolute top-0 left-0 right-0 bottom-0 p-10 opacity-0 transition-opacity hover:opacity-100 duration-500 hover:backdrop-blur-sm"
                        href="https://bit.ly/dokumentasigatheringbpiui2024">
                        <p class="font-bold text-3xl text-white">Gallery</p>
                    </a>
                </div>
            </div>
        </div>
        <div class="px-5 lg:px-32">
            <h1 class="font-bold text-3xl tracking-widest">Tentang BPI UI</h1>
            <div id="about">
                {!! $about->content !!}
            </div>
        </div>
        <div class="bg-orange-400 text-center py-10 text-white text-lg px-5 lg:text-2xl">
            <p>
                Whatsapp BPI UI Official :
                <a href="{{ $waLink }}?text=Hallo" class="hover:underline hover:text-orange-600 transition-all">{{
        ...
        <footer class="bg-white">
            <div class="mx-auto w-full p-4 py-6 lg:py-8">
                <div class="grid sm:grid-cols-3 xl:px-72 gap-5 sm:divide-x lg:gap-0">
                        ...
                        <div>
                            ...
                            <div class="mt-3 text-sm flex items-center gap-2">
                                ...
                                <a href="{{ $waLink }}?text=Hallo"
                                    class="hover:underline hover:text-orange-600 transition-all">Whatsapp</a>
                            </div>
                        </div>
                        <div class="flex mt-4 sm:mt-5">
                            <a class="text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2"
                ...
                <div class="sm:flex sm:items-center sm:justify-center">
                    <span class="text-sm text-gray-500 text-center"><span id="footer-year"></span> Hak Cipta,
    ...
    <button id="scrollTop"
        class="hidden fixed bottom-24 lg:bottom-32 lg:right-10 right-5 bg-amber-500 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-lg cursor-pointer z-50"
    ...
    <script type="module">
        ...
        ClassicEditor.create(document.querySelector('#about'), editorConfig)
            .then(editor => {
                ...
                editor.isReadOnly = true; // Set editor to read-only
                editor.ui.view.editable.element.style.border = 'none'; // Remove border
                editor.ui.view.editable.element.style.background = 'transparent'; // Remove background
            }).catch(err => {
                console.error(err)
            });
    </script>
