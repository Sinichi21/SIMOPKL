                        ...
                        <div class="col-lg-8 pr-lg-3">
                            ...
                            <div class="row">
                                <div class="col-12 form-group">
                                    ...
                                    <input type="text" id="partner_name" name="partner_name" class="form-control" value="{{ $mitra->partner_name }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 form-group">
                                    <label for="email">Email</label>
                                    <input type="email" id="email" name="email" class="form-control" value="{{ $mitra->email }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 form-group">
                                    <label for="website_address">Website</label>
                                    <input type="text" id="website_address" name="website_address" class="form-control" value="{{ $mitra->website_address }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 form-group">
                                    <label for="phoneNumber">No Telepon</label>
                                    <input type="text" id="phoneNumber" name="phoneNumber" class="form-control" value="{{ $mitra->phone_number }}">
                                </div>
                                <div class="col-6 form-group">
                                    <label for="Whatsapp_number">Whatsapp</label>
                                    <input type="text" id="Whatsapp_number" name="Whatsapp_number" class="form-control" value="{{ $mitra->whatsapp_number }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 form-group">
                                    <label for="address">Alamat</label>
                                    <input type="text" id="address" name="address" class="form-control" value="{{ $mitra->address }}">
                                </div>
                            </div>
                            <div class="row">
                                <!-- Field Deskripsi -->
                                <div class="col-12 form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="4">{{ $mitra->description ?? 'Tidak ada deskripsi.' }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-mt-3">
                        <div class="col-12 form-group">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input btn btn-outline-primary" id="statusActive" name="status" value="1" {{ $mitra->status == 1 ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-check-input btn btn-outline-primary" id="statusInactive" name="status" value="0" {{ $mitra->status == 0 ? 'checked' : '' }}>
