    ...
    <div class="container mt-4">
        ...
        <div class="shadow-lg card">
            <div class="card-body">
                ...
                <form id="periodForm" method="POST" action="{{ route('Period.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- Form Fields -->
                            <div class="row">
                                <div class="col-12 col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required placeholder="Periode 2023/2024">
                                </div>
                                <div class="col-12 col-md-6 form-group">
                                    <label for="start_date">Mulai</label>
                                    <input type="date" class="form-control" id="start date" name="start_date" required placeholder="01/09/2023">
                                </div>
                            </div>
                            <!-- More Form Fields -->
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 form-group">
                                    ...
                                    <input type="date" class="form-control" id="end_date" name="end_date" required placeholder="01/09/2023">
                                </div>
                            </div>
                        </div>
                    </div>
