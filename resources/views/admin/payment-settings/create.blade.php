<x-admin.layout>
    ...
    <div class="container mt-4">
        ...
        <div class="shadow-lg card">
            <div class="card-body">
                <form id="feeForm" method="POST" action="{{ route('payment-settings.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- Form Fields -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="image_file" id="image_file" class="custom-file-input" accept="image/png" required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-confirm').click(function(e) {
                e.preventDefault();
                Swal.fire({
                    title: 'Apakah Anda yakin ingin menambahkan rekening/e-wallet?',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('payment-settings.store') }}",
                            type: 'POST',
                            data: formData,
                            processData: false,
                            contentType: false,
