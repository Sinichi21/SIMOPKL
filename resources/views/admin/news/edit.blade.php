            ...
            <form id="newsForm" method="POST" action="{{ route('news.update', $news->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="image">{{ $news->image ? basename($news->image) : 'Choose File' }}</label>
                    </div>
                    <small class="form-text text-muted">Jenis file: jpg, jpeg, png.</small>
                    @if ($news->image)
                        <div class="mt-2">
                            <p>Gambar Sebelumnya</p>
                            <img src="{{ asset('storage/' . $news->image) }}" alt="Current Image" style="max-height: 150px;">
                        </div>
                    @endif
                </div>
                <div class="form-group">
                        ...
                        $.ajax({
                            ...
                            error: function(response) {
                                Swal.fire(
                                    ...
                                    'Gagal!',
                                    'Ada kesalahan saat mengedit berita.',
                                    'error'
                                );
                            }
                        });
