<x-admin.layout>
    ...
    <script type="module">
        ...
        ClassicEditor.create(document.querySelector('#answer'), editorConfig)
            .then(editor => {
                // Function to get all image URLs in the editor
                const getImages = () => {
                    return Array.from(editor.model.document.getRoot().getChildren())
                        .filter(element => element.name === 'imageBlock')
                ...
                editor.model.document.on('change:data', () => {
                    ...
                    //         // Here you can add your AJAX call to delete the image from the server
                    //         $.ajax({
                    //             type: 'POST',
                    //             url: "{{route('faq.upload.delete')}}",
                    //             data: { src: image },
                    //             headers: {
